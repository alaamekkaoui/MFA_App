...
def logout():
    ...
    if login_method == 'sso':
        ...
        if name_id:
            ...
            destination = "https://okta-dev-22490639.okta.com/app/dev-22490639_samlapp_1/0oafw8im5jJrYdA105d7/alnfw8pcq833G0UsZ5d7/slo/saml"
            relay_state = url_for('inde', _external=True)
